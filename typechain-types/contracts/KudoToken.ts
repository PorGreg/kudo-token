...
export interface KudoTokenInterface extends utils.Interface {
  functions: {
    ...
    "setMintable(address,uint16)": FunctionFragment;
...
export interface KudoToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KudoTokenInterface;
